...
#ifndef __cmhg_ScaleHdr_h
#define __cmhg_ScaleHdr_h
...
#define Module_Title                     "Scale"
#define Module_Help                      "Scale"
#define Module_VersionString             "0.16"
#define Module_VersionNumber             16
#ifndef Module_Date
 ...
 */
_kernel_oserror *Scale_init(const char *cmd_tail, int podule_base, void *pw);
 ...
 */
_kernel_oserror *Scale_finalise(int fatal, int podule, void *pw);
 ...
 */
void Scale_services(int service_number, _kernel_swi_regs *r, void *pw);
 ...
 */
#define Scale_00                        0x082c00
#ifndef Scale_ClassSWI
#define Scale_ClassSWI                  0x082c00
#define Scale_PostFilter                0x082c01
#define Scale_PreFilter                 0x082c02
#endif

#define error_BAD_SWI ((_kernel_oserror *) -1)

_kernel_oserror *Scale_SWI_handler(int swi_offset, _kernel_swi_regs *r, void *pw);
