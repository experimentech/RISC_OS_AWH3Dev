...
#ifndef __cmhg_FontMenuHdr_h
#define __cmhg_FontMenuHdr_h
...
#define Module_Title                     "FontMenu"
#define Module_Help                      "FontMenu"
 ...
 */
_kernel_oserror *FontMenu_init(const char *cmd_tail, int podule_base, void *pw);
 ...
 */
_kernel_oserror *FontMenu_finalise(int fatal, int podule, void *pw);
 ...
 */
void FontMenu_services(int service_number, _kernel_swi_regs *r, void *pw);
 ...
 * module FontMenu' to be returned.
 ...
 */
#define FontMenu_00                     0x082a40
#ifndef FontMenu_ClassSWI
#define FontMenu_ClassSWI               0x082a40
#define FontMenu_PostFilter             0x082a41
#define FontMenu_PreFilter              0x082a42
#endif

#define error_BAD_SWI ((_kernel_oserror *) -1)

_kernel_oserror *FontMenu_SWI_handler(int swi_offset, _kernel_swi_regs *r, void *pw);
