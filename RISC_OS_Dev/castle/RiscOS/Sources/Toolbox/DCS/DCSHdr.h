...
#ifndef __cmhg_DCSHdr_h
#define __cmhg_DCSHdr_h
...
#define Module_Title                     "DCS"
#define Module_Help                      "DCS Object"
#define Module_VersionString             "1.14"
#define Module_VersionNumber             114
#ifndef Module_Date
 ...
 */
_kernel_oserror *DCS_init(const char *cmd_tail, int podule_base, void *pw);
 ...
 */
_kernel_oserror *DCS_final(int fatal, int podule, void *pw);
 ...
 */
void DCS_services(int service_number, _kernel_swi_regs *r, void *pw);
 ...
 */
#define DCS_00                          0x082a80
#ifndef DCS_ClassSWI
#define DCS_ClassSWI                    0x082a80
#define DCS_PostFilter                  0x082a81
#define DCS_PreFilter                   0x082a82
#endif

#define error_BAD_SWI ((_kernel_oserror *) -1)

_kernel_oserror *DCS_SWI_handler(int swi_offset, _kernel_swi_regs *r, void *pw);
