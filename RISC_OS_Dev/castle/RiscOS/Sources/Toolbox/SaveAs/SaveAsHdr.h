...
#ifndef __cmhg_SaveAsHdr_h
#define __cmhg_SaveAsHdr_h
...
#define Module_Title                     "SaveAs"
#define Module_Help                      "SaveAs"
 ...
 */
_kernel_oserror *SaveAs_init(const char *cmd_tail, int podule_base, void *pw);
 ...
 */
_kernel_oserror *SaveAs_finalise(int fatal, int podule, void *pw);
 ...
 */
void SaveAs_services(int service_number, _kernel_swi_regs *r, void *pw);
 ...
 */
#define SaveAs_00                       0x082bc0
#ifndef SaveAs_ClassSWI
#define SaveAs_ClassSWI                 0x082bc0
#define SaveAs_PostFilter               0x082bc1
#define SaveAs_PreFilter                0x082bc2
#endif

#define error_BAD_SWI ((_kernel_oserror *) -1)

_kernel_oserror *SaveAs_SWI_handler(int swi_offset, _kernel_swi_regs *r, void *pw);
