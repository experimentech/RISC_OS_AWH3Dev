...
#ifndef __cmhg_PrintDboxHdr_h
#define __cmhg_PrintDboxHdr_h
...
#define Module_Title                     "PrintDbox"
#define Module_Help                      "PrintDbox"
 ...
 */
_kernel_oserror *PrintDbox_init(const char *cmd_tail, int podule_base, void *pw);
 ...
 */
_kernel_oserror *PrintDbox_finalise(int fatal, int podule, void *pw);
 ...
 */
void PrintDbox_services(int service_number, _kernel_swi_regs *r, void *pw);
 ...
 * module PrintDbox' to be returned.
 ...
 */
#define PrintDbox_00                    0x082b00
#ifndef PrintDbox_ClassSWI
#define PrintDbox_ClassSWI              0x082b00
#define PrintDbox_PostFilter            0x082b01
#define PrintDbox_PreFilter             0x082b02
#endif

#define error_BAD_SWI ((_kernel_oserror *) -1)

_kernel_oserror *PrintDbox_SWI_handler(int swi_offset, _kernel_swi_regs *r, void *pw);
