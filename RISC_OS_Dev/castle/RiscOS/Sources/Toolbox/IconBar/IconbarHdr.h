...
#ifndef __cmhg_IconbarHdr_h
#define __cmhg_IconbarHdr_h
...
#define Module_Title                     "Iconbar"
#define Module_Help                      "Iconbar"
#define Module_VersionString             "1.23"
#define Module_VersionNumber             123
#ifndef Module_Date
 ...
 */
_kernel_oserror *Iconbar_init(const char *cmd_tail, int podule_base, void *pw);
 ...
 */
_kernel_oserror *Iconbar_finalise(int fatal, int podule, void *pw);
 ...
 */
void Iconbar_services(int service_number, _kernel_swi_regs *r, void *pw);
 ...
 */
#define Iconbar_00                      0x082900
#ifndef Iconbar_ClassSWI
#define Iconbar_ClassSWI                0x082900
#define Iconbar_PostFilter              0x082901
#define Iconbar_PreFilter               0x082902
#endif

#define error_BAD_SWI ((_kernel_oserror *) -1)

_kernel_oserror *Iconbar_SWI_handler(int swi_offset, _kernel_swi_regs *r, void *pw);
