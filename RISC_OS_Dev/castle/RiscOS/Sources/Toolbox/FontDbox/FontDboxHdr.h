...
#ifndef __cmhg_FontDboxHdr_h
#define __cmhg_FontDboxHdr_h
...
#define Module_Title                     "FontDbox"
#define Module_Help                      "FontDbox"
 ...
 */
_kernel_oserror *FontDbox_init(const char *cmd_tail, int podule_base, void *pw);
 ...
 */
_kernel_oserror *FontDbox_finalise(int fatal, int podule, void *pw);
 ...
 */
void FontDbox_services(int service_number, _kernel_swi_regs *r, void *pw);
 ...
 * module FontDbox' to be returned.
 ...
 */
#define FontDbox_00                     0x082a00
#ifndef FontDbox_ClassSWI
#define FontDbox_ClassSWI               0x082a00
#define FontDbox_PostFilter             0x082a01
#define FontDbox_PreFilter              0x082a02
#endif

#define error_BAD_SWI ((_kernel_oserror *) -1)

_kernel_oserror *FontDbox_SWI_handler(int swi_offset, _kernel_swi_regs *r, void *pw);
