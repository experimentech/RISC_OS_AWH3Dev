...
#ifndef __cmhg_ColourMenuHdr_h
#define __cmhg_ColourMenuHdr_h
...
#define Module_Title                     "ColourMenu"
#define Module_Help                      "ColourMenu"
 ...
 */
_kernel_oserror *ColourMenu_init(const char *cmd_tail, int podule_base, void *pw);
 ...
 */
_kernel_oserror *ColourMenu_finalise(int fatal, int podule, void *pw);
 ...
 */
void ColourMenu_services(int service_number, _kernel_swi_regs *r, void *pw);
 ...
 * module ColourMenu' to be returned.
 ...
 */
#define ColourMenu_00                   0x082980
#ifndef ColourMenu_ClassSWI
#define ColourMenu_ClassSWI             0x082980
#define ColourMenu_PostFilter           0x082981
#define ColourMenu_PreFilter            0x082982
#endif

#define error_BAD_SWI ((_kernel_oserror *) -1)

_kernel_oserror *ColourMenu_SWI_handler(int swi_offset, _kernel_swi_regs *r, void *pw);
