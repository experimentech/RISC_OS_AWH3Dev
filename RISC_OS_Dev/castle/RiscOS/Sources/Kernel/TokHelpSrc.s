...
Cache_Help
      ;=   "*",TokenEscapeChar,Token0
     =  "*",TokenEscapeChar,Token0," turns",TokenEscapeChar,Token2,"c"
     =  "ache on or off, or gives",TokenEscapeChar,Token2,"cache stat"
     =  "e.", 13
      ;=   " turns the cache on or off, or gives the cache state.",13
Cache_Syntax
      ;=   "Syntax: *",TokenEscapeChar,Token0
     =  TokenEscapeChar,Token30,"On|Off]",  0
      ;=   " [On|Off]", 0
...
Save_Syntax
      ;=   "Syntax: *",TokenEscapeChar,Token0
     =  TokenEscapeChar,Token27," <start addr> <+length|end addr> [<e"
     =  "xec addr> [<load addr>]]",  0
...
TV_Help
      ;=   "*",TokenEscapeChar,Token0
     =  "*",TokenEscapeChar,Token0," controls interlacing"
     =  TokenEscapeChar,Token16,TokenEscapeChar,Token19,"posi"
     =  TokenEscapeChar,Token9," of",TokenEscapeChar,Token2,"displ"
     =  "ay on",TokenEscapeChar,Token2,"screen.",  0
      ;=   " controls interlacing and sets the position of the display on the screen.", 0

TV_Syntax
      ;=   "*",TokenEscapeChar,Token0
     =  "*",TokenEscapeChar,Token0," [<vertical posi"
     =  TokenEscapeChar,Token9,"> [[,] <interlace>]]",  0
