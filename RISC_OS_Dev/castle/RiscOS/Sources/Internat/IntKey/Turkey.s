...
LLK     SETS    "DCB"
KeyStructPC20
        &       KeyTranPC20-KeyStructPC20
        &       ((KeyTranPC20End-KeyTranPC20) :SHR: (LLKS+2))
        &       InkeyTranPC-KeyStructPC20
        &       ShiftingKeyList-KeyStructPC20
        &       SpecialListPC20-KeyStructPC20
        &       SpecialCodeTable-KeyStructPC20
        &       KeyStructInit-KeyStructPC20
        &       PendingAltCode-KeyStructPC20
        &       &00000000
        &       PadKNumTran-KeyStructPC20-((SpecialListPC20Pad-SpecialListPC20):SHR:LLKS)
        &       PadKCurTran-KeyStructPC20-((SpecialListPC20Pad-SpecialListPC20):SHR:LLKS)
        &       0
        &       UCSTablePC20_0-KeyStructPC20-((SpecialListPC20UCS-SpecialListPC20):SHR:LLKS)*36
        &       UCSTablePC20_0-KeyStructPC20-((SpecialListPC20UCS-SpecialListPC20):SHR:LLKS)*36
...
SpecialListPC20
        $LLK    ((SpecialListPC20End - SpecialListPC20) :SHR: LLKS) - 1
        $LLK    KeyNo_ShiftLeft
...
SpecialListPC20Pad
        ...
        $LLK    KeyNo_CapsLock
SpecialListPC20UCS
        $LLK    &01, &02, &0C, &10, &11, &13, &14, &15
        $LLK    &17, &18, &19, &1A, &1B, &1C, &27, &28
        $LLK    &29, &2A, &2B, &2C, &2E, &2F, &31, &32
        $LLK    &33, &34, &3C, &3D, &3F, &45, &46, &4D
        $LLK    &4E, &4F, &50, &51, &52, &53, &54, &55
        $LLK    &56, &57, &5F
SpecialListPC20End
        ALIGN
        ASSERT ((SpecialListPC20End-SpecialListPC20):SHR:LLKS)-1 <= (SpecialCodeTableEnd-SpecialCodeTable):SHR:2
...
UCSTablePC20_0
        ...
        &       &00000022,&000000E9,&FFFFFFFF,&FFFFFFFF ; &10
        &       &FFFFFFFF,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000031,&00000021,&00000001,&00000001 ; &11
        &       &FFFFFFFF,&000000A1,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000033,&80020003,&0000001E,&0000001E ; &13
        &       &00000023,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000034,&0000002B,&00000004,&00000004 ; &14
        ...
        &       &0000002A,&0000003F,&0000001C,&0000001C ; &1B
        &       &0000005C,&000000BF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &0000002D,&0000005F,&0000001F,&0000001F ; &1C
        &       &000000A3,&000000A4,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000071,&00000051,&00000011,&00000011 ; &27
        &       &00000040,&FFFFFFFF,&00000000,&00000000, &76543281
        ...
        &       &00000131,&00000049,&00000009,&00000009 ; &2E
        ...
        &       &0000011F,&0000011E,&FFFFFFFF,&FFFFFFFF ; &31
        &       &80020008,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543281
        &       &000000FC,&000000DC,&FFFFFFFF,&FFFFFFFF ; &32
        &       &80020004,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543281
        &       &0000002C,&0000003B,&FFFFFFFF,&FFFFFFFF ; &33
        ...
        &       &0000015F,&0000015E,&FFFFFFFF,&FFFFFFFF ; &45
        &       &80020002,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543281
        &       &00000069,&00000130,&FFFFFFFF,&FFFFFFFF ; &46
        &       &80020006,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543281
        ...
        &       &000000F6,&000000D6,&FFFFFFFF,&FFFFFFFF ; &55
        &       &FFFFFFFF,&000000D7,&FFFFFFFF,&FFFFFFFF, &76543281
        &       &000000E7,&000000C7,&FFFFFFFF,&FFFFFFFF ; &56
        &       &80020007,&000000F7,&FFFFFFFF,&FFFFFFFF, &76543281
        &       &0000002E,&0000003A,&FFFFFFFF,&FFFFFFFF ; &57
        &       &80020010,&00002026,&FFFFFFFF,&FFFFFFFF, &76543210
