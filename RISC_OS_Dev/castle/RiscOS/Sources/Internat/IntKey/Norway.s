...
LLK     SETS    "DCB"
KeyStructPC15
        &       KeyTranPC15-KeyStructPC15
        &       ((KeyTranPC15End-KeyTranPC15) :SHR: (LLKS+2))
        &       InkeyTranPC-KeyStructPC15
        &       ShiftingKeyList-KeyStructPC15
        &       SpecialListPC15-KeyStructPC15
        &       SpecialCodeTable-KeyStructPC15
        &       KeyStructInit-KeyStructPC15
        &       PendingAltCode-KeyStructPC15
        &       &00000000
        &       PadKPC15NumTran-KeyStructPC15-((SpecialListPC15Pad-SpecialListPC15):SHR:LLKS)
        &       PadKPC15CurTran-KeyStructPC15-((SpecialListPC15Pad-SpecialListPC15):SHR:LLKS)
        &       0
        &       UCSTablePC15_0-KeyStructPC15-((SpecialListPC15UCS-SpecialListPC15):SHR:LLKS)*36
        &       UCSTablePC15_0-KeyStructPC15-((SpecialListPC15UCS-SpecialListPC15):SHR:LLKS)*36
...
SpecialListPC15
        $LLK    ((SpecialListPC15End - SpecialListPC15) :SHR: LLKS) - 1
        $LLK    KeyNo_ShiftLeft
...
SpecialListPC15UCS
        ...
        $LLK    &1D, &27, &29, &2A, &2B, &2C, &2E, &30
        $LLK    &31, &32, &33, &34, &3D, &3E, &3F, &44
        $LLK    &45, &46, &4D, &4E, &4F, &50, &51, &52
        $LLK    &53, &54, &55, &56, &57, &5F
SpecialListPC15End
        ALIGN
        ASSERT ((SpecialListPC15End-SpecialListPC15):SHR:LLKS)-1 <= (SpecialCodeTableEnd-SpecialCodeTable):SHR:2
...
UCSTablePC15_0
        ...
        &       &0000007C,&000000A7,&FFFFFFFF,&FFFFFFFF ; &10
        ...
        &       &00000024,&000000BC,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000035,&00000025,&00000005,&00000005 ; &15
        &       &FFFFFFFF,&000000BD,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000036,&00000026,&00000006,&00000006 ; &16
        &       &FFFFFFFF,&000000BE,&FFFFFFFF,&FFFFFFFF, &76543210
        ...
        &       &0000005C,&80020001,&0000001C,&0000001C ; &1C
        ...
        &       &000000F8,&000000D8,&FFFFFFFF,&FFFFFFFF ; &45
        &       &000000F6,&000000D6,&FFFFFFFF,&FFFFFFFF, &76C53281
        &       &000000E6,&000000C6,&FFFFFFFF,&FFFFFFFF ; &46
        &       &000000E4,&000000C4,&FFFFFFFF,&FFFFFFFF, &76C53281
