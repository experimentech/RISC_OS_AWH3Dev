...
LLK     SETS    "DCB"
KeyStructPC31
        &       KeyTranPC31-KeyStructPC31
        &       ((KeyTranPC31End-KeyTranPC31) :SHR: (LLKS+2))
        &       InkeyTranPC-KeyStructPC31
        &       ShiftingKeyList-KeyStructPC31
        &       SpecialListPC31-KeyStructPC31
        &       SpecialCodeTable-KeyStructPC31
        &       KeyStructInit-KeyStructPC31
        &       PendingAltCode-KeyStructPC31
        &       &00000000
        &       PadKNumTran-KeyStructPC31-((SpecialListPC31Pad-SpecialListPC31):SHR:LLKS)
        &       PadKCurTran-KeyStructPC31-((SpecialListPC31Pad-SpecialListPC31):SHR:LLKS)
        &       0
        &       UCSTablePC31_0-KeyStructPC31-((SpecialListPC31UCS-SpecialListPC31):SHR:LLKS)*36
        &       UCSTablePC31_0-KeyStructPC31-((SpecialListPC31UCS-SpecialListPC31):SHR:LLKS)*36
...
SpecialListPC31
        $LLK    ((SpecialListPC31End - SpecialListPC31) :SHR: LLKS) - 1
        $LLK    KeyNo_ShiftLeft
...
SpecialListPC31UCS
        ...
        $LLK    &27, &29, &2A, &2B, &2C, &2E, &2F, &30
        $LLK    &31, &32, &33, &34, &3C, &3D, &3E, &3F
        $LLK    &44, &45, &46, &4D, &4E, &4F, &50, &51
        $LLK    &52, &53, &54, &55, &56, &57, &5F
SpecialListPC31End
        ALIGN
        ASSERT ((SpecialListPC31End-SpecialListPC31):SHR:LLKS)-1 <= (SpecialCodeTableEnd-SpecialCodeTable):SHR:2
...
UCSTablePC31_0
        ...
        &       &000000E9,&00000032,&00000000,&00000000 ; &12
        ...
        &       &00000029,&000000B0,&0000001C,&0000001C ; &1B
        &       &FFFFFFFF,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &0000002D,&0000005F,&0000001F,&0000001F ; &1C
        ...
        &       &80020003,&80020008,&0000001B,&0000001B ; &31
        &       &0000005B,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000024,&0000002A,&0000001D,&0000001D ; &32
        &       &0000005D,&00002022,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &000000B5,&000000A3,&FFFFFFFF,&FFFFFFFF ; &33
        ...
        &       &FFFFFFFF,&000000BA,&FFFFFFFF,&FFFFFFFF, &76543281
        ...
        &       &0000003D,&0000002B,&FFFFFFFF,&FFFFFFFF ; &57
        &       &0000007E,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
