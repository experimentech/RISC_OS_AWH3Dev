...
LLK     SETS    "DCB"
KeyStructPC34
        &       KeyTranPC34-KeyStructPC34
        &       ((KeyTranPC34End-KeyTranPC34) :SHR: (LLKS+2))
        &       InkeyTranPC-KeyStructPC34
        &       ShiftingKeyList-KeyStructPC34
        &       SpecialListPC34-KeyStructPC34
        &       SpecialCodeTable-KeyStructPC34
        &       KeyStructInit-KeyStructPC34
        &       PendingAltCode-KeyStructPC34
        &       &00000000
        &       PadKNumTran-KeyStructPC34-((SpecialListPC34Pad-SpecialListPC34):SHR:LLKS)
        &       PadKCurTran-KeyStructPC34-((SpecialListPC34Pad-SpecialListPC34):SHR:LLKS)
        &       0
        &       UCSTablePC34_0-KeyStructPC34-((SpecialListPC34UCS-SpecialListPC34):SHR:LLKS)*36
        &       UCSTablePC34_0-KeyStructPC34-((SpecialListPC34UCS-SpecialListPC34):SHR:LLKS)*36
...
SpecialListPC34
        $LLK    ((SpecialListPC34End - SpecialListPC34) :SHR: LLKS) - 1
        $LLK    KeyNo_ShiftLeft
...
SpecialListPC34UCS
        ...
        $LLK    &15, &16, &17, &18, &19, &1B, &1C, &27
        $LLK    &29, &2A, &2B, &2C, &2E, &2F, &30, &31
        $LLK    &32, &34, &3C, &3D, &3E, &3F, &44, &45
        $LLK    &46, &4D, &4E, &4F, &50, &51, &52, &53
        $LLK    &54, &55, &56, &57, &5F
SpecialListPC34End
        ALIGN
        ASSERT ((SpecialListPC34End-SpecialListPC34):SHR:LLKS)-1 <= (SpecialCodeTableEnd-SpecialCodeTable):SHR:2
...
UCSTablePC34_0
        ...
        &       &00000040,&000000A7,&00000000,&00000000 ; &10
        ...
        &       &00000037,&0000005F,&0000001F,&0000001F ; &17
        &       &000000A3,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        ...
        &       &0000002F,&0000003F,&0000001C,&0000001C ; &1B
        &       &0000005C,&000000BF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &80020009,&80020004,&FFFFFFFF,&FFFFFFFF ; &1C
        &       &8002000D,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        ...
        &       &80020008,&80020003,&FFFFFFFF,&FFFFFFFF ; &31
        &       &FFFFFFFF,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &0000002A,&0000007C,&FFFFFFFF,&FFFFFFFF ; &32
        ...
        &       &0000002B,&000000B1,&FFFFFFFF,&FFFFFFFF ; &45
        &       &FFFFFFFF,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &80020002,&80020001,&FFFFFFFF,&FFFFFFFF ; &46
        &       &FFFFFFFF,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &0000005B,&0000005D,&0000001B,&0000001D ; &4D
        ...
        &       &0000002D,&0000003D,&FFFFFFFF,&FFFFFFFF ; &57
