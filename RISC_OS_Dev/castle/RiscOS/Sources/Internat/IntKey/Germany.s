...
LLK     SETS    "DCB"
KeyStructPC7
        &       KeyTranPC7-KeyStructPC7
        &       ((KeyTranPC7End-KeyTranPC7) :SHR: (LLKS+2))
        &       InkeyTranPC-KeyStructPC7
        &       ShiftingKeyList-KeyStructPC7
        &       SpecialListPC7-KeyStructPC7
        &       SpecialCodeTable-KeyStructPC7
        &       KeyStructInit-KeyStructPC7
        &       PendingAltCode-KeyStructPC7
        &       &00000000
        &       PadKNumTran-KeyStructPC7-((SpecialListPC7Pad-SpecialListPC7):SHR:LLKS)
        &       PadKCurTran-KeyStructPC7-((SpecialListPC7Pad-SpecialListPC7):SHR:LLKS)
        &       0
        &       UCSTablePC7_0-KeyStructPC7-((SpecialListPC7UCS-SpecialListPC7):SHR:LLKS)*36
        &       UCSTablePC7_0-KeyStructPC7-((SpecialListPC7UCS-SpecialListPC7):SHR:LLKS)*36
...
SpecialListPC7
        $LLK    ((SpecialListPC7End - SpecialListPC7) :SHR: LLKS) - 1
        $LLK    KeyNo_ShiftLeft
...
SpecialListPC7UCS
        ...
        $LLK    &1D, &27, &28, &29, &2A, &2B, &2E, &2F
        $LLK    &30, &31, &32, &33, &34, &3C, &3E, &3F
        $LLK    &44, &45, &46, &4D, &4E, &4F, &50, &51
        $LLK    &52, &53, &54, &55, &56, &57, &5F
SpecialListPC7End
        ALIGN
        ASSERT ((SpecialListPC7End-SpecialListPC7):SHR:LLKS)-1 <= (SpecialCodeTableEnd-SpecialCodeTable):SHR:2
...
UCSTablePC7_0
        ...
        &       &0000005E,&000000B0,&0000001E,&0000001E ; &10
        ...
        &       &00000033,&000000A7,&00000003,&00000003 ; &13
        ...
        &       &000000DF,&0000003F,&0000001C,&0000001C ; &1B
        ...
        &       &00000040,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543281
        ...
        &       &000000FC,&000000DC,&FFFFFFFF,&FFFFFFFF ; &31
        &       &FFFFFFFF,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543281
        &       &0000002B,&0000002A,&FFFFFFFF,&FFFFFFFF ; &32
        &       &0000007E,&00002022,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000023,&00000027,&FFFFFFFF,&FFFFFFFF ; &33
        ...
        &       &000000F6,&000000D6,&FFFFFFFF,&FFFFFFFF ; &45
        &       &FFFFFFFF,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543281
        &       &000000E4,&000000C4,&FFFFFFFF,&FFFFFFFF ; &46
        &       &FFFFFFFF,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543281
