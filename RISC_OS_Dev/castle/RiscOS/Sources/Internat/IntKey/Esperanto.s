...
LLK     SETS    "DCB"
KeyStructPC9
        &       KeyTranPC9-KeyStructPC9
        &       ((KeyTranPC9End-KeyTranPC9) :SHR: (LLKS+2))
        &       InkeyTranPC-KeyStructPC9
        &       ShiftingKeyList-KeyStructPC9
        &       SpecialListPC9-KeyStructPC9
        &       SpecialCodeTable-KeyStructPC9
        &       KeyStructInit-KeyStructPC9
        &       PendingAltCode-KeyStructPC9
        &       &00000000
        &       PadKNumTran-KeyStructPC9-((SpecialListPC9Pad-SpecialListPC9):SHR:LLKS)
        &       PadKCurTran-KeyStructPC9-((SpecialListPC9Pad-SpecialListPC9):SHR:LLKS)
        &       0
        &       UCSTablePC9_0-KeyStructPC9-((SpecialListPC9UCS-SpecialListPC9):SHR:LLKS)*36
        &       UCSTablePC9_0-KeyStructPC9-((SpecialListPC9UCS-SpecialListPC9):SHR:LLKS)*36
...
SpecialListPC9
        $LLK    ((SpecialListPC9End - SpecialListPC9) :SHR: LLKS) - 1
        $LLK    KeyNo_ShiftLeft
...
SpecialListPC9UCS
        ...
        $LLK    &27, &2A, &2B, &2C, &2D, &2E, &2F, &30
        $LLK    &31, &32, &33, &34, &3C, &3D, &3E, &3F
        $LLK    &40, &41, &42, &44, &45, &46, &4D, &4E
        $LLK    &4F, &50, &51, &52, &53, &54, &55, &56
        $LLK    &57, &5F
SpecialListPC9End
        ALIGN
        ASSERT ((SpecialListPC9End-SpecialListPC9):SHR:LLKS)-1 <= (SpecialCodeTableEnd-SpecialCodeTable):SHR:2
...
UCSTablePC9_0
        ...
        &       &00000033,&000000A4,&00000003,&00000003 ; &13
        ...
        &       &0000016D,&0000016C,&FFFFFFFF,&FFFFFFFF, &76C53281
        ...
        &       &80020006,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        ...
        &       &0000015D,&0000015C,&000000DF,&000000A7, &76C53281
        ...
        &       &0000011D,&0000011C,&FFFFFFFF,&FFFFFFFF, &76C53281
        &       &00000068,&00000048,&00000008,&00000008 ; &41
        &       &00000125,&00000124,&FFFFFFFF,&FFFFFFFF, &76C53281
        &       &0000006A,&0000004A,&0000000A,&0000000A ; &42
        &       &00000135,&00000134,&FFFFFFFF,&FFFFFFFF, &76C53281
        ...
        &       &00000109,&00000108,&000000A2,&000000A9, &76C53281
        ...
        &       &80020007,&000000F7,&FFFFFFFF,&FFFFFFFF, &76543210
