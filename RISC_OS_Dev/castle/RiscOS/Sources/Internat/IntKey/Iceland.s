...
LLK     SETS    "DCB"
KeyStructPC16
        &       KeyTranPC16-KeyStructPC16
        &       ((KeyTranPC16End-KeyTranPC16) :SHR: (LLKS+2))
        &       InkeyTranPC-KeyStructPC16
        &       ShiftingKeyList-KeyStructPC16
        &       SpecialListPC16-KeyStructPC16
        &       SpecialCodeTable-KeyStructPC16
        &       KeyStructInit-KeyStructPC16
        &       PendingAltCode-KeyStructPC16
        &       &00000000
        &       PadKNumTran-KeyStructPC16-((SpecialListPC16Pad-SpecialListPC16):SHR:LLKS)
        &       PadKCurTran-KeyStructPC16-((SpecialListPC16Pad-SpecialListPC16):SHR:LLKS)
        &       0
        &       UCSTablePC16_0-KeyStructPC16-((SpecialListPC16UCS-SpecialListPC16):SHR:LLKS)*36
        &       UCSTablePC16_0-KeyStructPC16-((SpecialListPC16UCS-SpecialListPC16):SHR:LLKS)*36
...
SpecialListPC16
        $LLK    ((SpecialListPC16End - SpecialListPC16) :SHR: LLKS) - 1
        $LLK    KeyNo_ShiftLeft
...
SpecialListPC16UCS
        ...
        $LLK    &27, &28, &29, &2A, &2B, &2C, &2E, &2F
        $LLK    &31, &32, &33, &34, &3D, &3F, &44, &45
        $LLK    &46, &4D, &4E, &4F, &50, &51, &52, &53
        $LLK    &54, &55, &56, &57, &5F
SpecialListPC16End
        ALIGN
        ASSERT ((SpecialListPC16End-SpecialListPC16):SHR:LLKS)-1 <= (SpecialCodeTableEnd-SpecialCodeTable):SHR:2
...
UCSTablePC16_0
        ...
        &       &80020009,&80020008,&FFFFFFFF,&FFFFFFFF ; &10
        ...
        &       &0000005D,&000000B1,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000030,&0000003D,&00000000,&00000000 ; &1A
        &       &0000007D,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &000000F6,&000000D6,&0000001C,&0000001C ; &1B
        &       &0000005C,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543281
        ...
        &       &000000F0,&000000D0,&FFFFFFFF,&FFFFFFFF ; &31
        &       &00002013,&00002014,&FFFFFFFF,&FFFFFFFF, &76543281
        &       &00000027,&0000003F,&FFFFFFFF,&FFFFFFFF ; &32
        &       &80020004,&000000BF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &0000002B,&0000002A,&FFFFFFFF,&FFFFFFFF ; &33
        ...
        &       &000000B7,&00002022,&FFFFFFFF,&FFFFFFFF, &76543281
        &       &80020002,&80020002,&FFFFFFFF,&FFFFFFFF ; &46
        ...
        &       &000000FE,&000000DE,&FFFFFFFF,&FFFFFFFF ; &57
