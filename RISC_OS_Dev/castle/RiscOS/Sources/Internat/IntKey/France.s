...
LLK     SETS    "DCB"
KeyStructPC6
        &       KeyTranPC6-KeyStructPC6
        &       ((KeyTranPC6End-KeyTranPC6) :SHR: (LLKS+2))
        &       InkeyTranPC-KeyStructPC6
        &       ShiftingKeyList-KeyStructPC6
        &       SpecialListPC6-KeyStructPC6
        &       SpecialCodeTable-KeyStructPC6
        &       KeyStructInit-KeyStructPC6
        &       PendingAltCode-KeyStructPC6
        &       &00000000
        &       PadKNumTran-KeyStructPC6-((SpecialListPC6Pad-SpecialListPC6):SHR:LLKS)
        &       PadKCurTran-KeyStructPC6-((SpecialListPC6Pad-SpecialListPC6):SHR:LLKS)
        &       0
        &       UCSTablePC6_0-KeyStructPC6-((SpecialListPC6UCS-SpecialListPC6):SHR:LLKS)*36
        &       UCSTablePC6_0-KeyStructPC6-((SpecialListPC6UCS-SpecialListPC6):SHR:LLKS)*36
...
SpecialListPC6
        $LLK    ((SpecialListPC6End - SpecialListPC6) :SHR: LLKS) - 1
        $LLK    KeyNo_ShiftLeft
...
SpecialListPC6UCS
        ...
        $LLK    &1D, &27, &29, &2A, &2B, &2C, &2E, &2F
        $LLK    &30, &31, &32, &33, &34, &3C, &3D, &3E
        $LLK    &3F, &45, &46, &4D, &4E, &4F, &50, &51
        $LLK    &52, &53, &54, &55, &56, &57, &5F
SpecialListPC6End
        ALIGN
        ASSERT ((SpecialListPC6End-SpecialListPC6):SHR:LLKS)-1 <= (SpecialCodeTableEnd-SpecialCodeTable):SHR:2
...
UCSTablePC6_0
        ...
        &       &000000B2,&000000B3,&FFFFFFFF,&FFFFFFFF ; &10
        &       &000000AC,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000026,&00000031,&00000001,&00000001 ; &11
        &       &000000B9,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &000000E9,&00000032,&00000002,&00000002 ; &12
        &       &80020004,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000022,&00000033,&00000003,&00000003 ; &13
        &       &00000023,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000027,&00000034,&00000004,&00000004 ; &14
        &       &0000007B,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000028,&00000035,&0000001B,&0000001B ; &15
        &       &0000005B,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &0000002D,&00000036,&00000006,&00000006 ; &16
        &       &0000007C,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &000000E8,&00000037,&00000007,&00000007 ; &17
        &       &80020001,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &0000005F,&00000038,&0000001F,&0000001F ; &18
        &       &0000005C,&FFFFFFFF,&0000001C,&0000001C, &76543210
        &       &000000E7,&00000039,&0000001E,&0000001E ; &19
        &       &0000005E,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &000000E0,&00000030,&00000000,&00000000 ; &1A
        &       &00000040,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000029,&000000B0,&0000001D,&0000001D ; &1B
        &       &0000005D,&000000BF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &0000003D,&0000002B,&FFFFFFFF,&FFFFFFFF ; &1C
        &       &0000007D,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &0000003C,&0000003E,&FFFFFFFF,&FFFFFFFF ; &1D
        &       &0000007C,&000000A6,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000061,&00000041,&00000001,&00000001 ; &27
        ...
        &       &80020003,&80020008,&FFFFFFFF,&FFFFFFFF ; &31
        &       &FFFFFFFF,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000024,&000000A3,&FFFFFFFF,&FFFFFFFF ; &32
        &       &000000A4,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &0000002A,&000000B5,&FFFFFFFF,&FFFFFFFF ; &33
        &       &00002022,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &80010009,&80010009,&80010009,&80010009 ; &34
        &       &FFFFFFFF,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000071,&00000051,&00000011,&00000011 ; &3C
        ...
        &       &0000006D,&0000004D,&0000000D,&0000000D ; &45
        &       &000000B5,&000000BA,&FFFFFFFF,&FFFFFFFF, &76543281
        &       &000000F9,&00000025,&FFFFFFFF,&FFFFFFFF ; &46
        &       &FFFFFFFF,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &0000003C,&0000003E,&FFFFFFFF,&FFFFFFFF ; &4D
        &       &0000007C,&000000A6,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000077,&00000057,&00000017,&00000017 ; &4E
        ...
        &       &0000002C,&0000003F,&FFFFFFFF,&FFFFFFFF ; &54
        &       &FFFFFFFF,&000000BF,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &0000003B,&0000002E,&FFFFFFFF,&FFFFFFFF ; &55
        &       &FFFFFFFF,&000000D7,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &0000003A,&0000002F,&FFFFFFFF,&FFFFFFFF ; &56
        &       &FFFFFFFF,&000000F7,&FFFFFFFF,&FFFFFFFF, &76543210
        &       &00000021,&000000A7,&FFFFFFFF,&FFFFFFFF ; &57
        &       &000000A1,&FFFFFFFF,&FFFFFFFF,&FFFFFFFF, &76543210
