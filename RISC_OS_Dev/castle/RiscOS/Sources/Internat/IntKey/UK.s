...
LLK     SETS    "DCB"
KeyStructPC1
        &       KeyTranPC1-KeyStructPC1
        &       ((KeyTranPC1End-KeyTranPC1) :SHR: (LLKS+2))
        &       InkeyTranPC-KeyStructPC1
        &       ShiftingKeyList-KeyStructPC1
        &       SpecialListPC1-KeyStructPC1
        &       SpecialCodeTable-KeyStructPC1
        &       KeyStructInit-KeyStructPC1
        &       PendingAltCode-KeyStructPC1
        &       &00000000
        &       PadKNumTran-KeyStructPC1-((SpecialListPC1Pad-SpecialListPC1):SHR:LLKS)
        &       PadKCurTran-KeyStructPC1-((SpecialListPC1Pad-SpecialListPC1):SHR:LLKS)
        &       0
        &       UCSTablePC1_0-KeyStructPC1-((SpecialListPC1UCS-SpecialListPC1):SHR:LLKS)*36
        &       UCSTablePC1_0-KeyStructPC1-((SpecialListPC1UCS-SpecialListPC1):SHR:LLKS)*36
...
SpecialListPC1
        $LLK    ((SpecialListPC1End - SpecialListPC1) :SHR: LLKS) - 1
        $LLK    KeyNo_ShiftLeft
...
SpecialListPC1UCS
        ...
        $LLK    &27, &2A, &2B, &2C, &2E, &2F, &30, &31
        $LLK    &32, &33, &34, &3C, &3D, &3E, &3F, &44
        $LLK    &45, &46, &4D, &4E, &4F, &50, &51, &52
        $LLK    &53, &54, &55, &56, &57, &5F
SpecialListPC1End
        ALIGN
        ASSERT ((SpecialListPC1End-SpecialListPC1):SHR:LLKS)-1 <= (SpecialCodeTableEnd-SpecialCodeTable):SHR:2
