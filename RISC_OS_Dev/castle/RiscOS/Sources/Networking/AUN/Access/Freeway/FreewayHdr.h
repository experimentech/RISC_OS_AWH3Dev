...
#ifndef __cmhg_FreewayHdr_h
#define __cmhg_FreewayHdr_h
...
#define Module_Title                     "Freeway"
#define Module_Help                      "Freeway"
#define Module_VersionString             "0.41"
#define Module_VersionNumber             41
#ifndef Module_Date
#define Module_Date                      "26 May 2017"
#endif
#define Module_MessagesFile              "Resources:$.Resources.Freeway.Messages"
 ...
 */
_kernel_oserror *fw_init(const char *cmd_tail, int podule_base, void *pw);
...
#define CMD_FwShow                      0
#define CMD_FwAddNet                    1
#define CMD_FreewayAutoAddress          2

_kernel_oserror *fw_cli_handler(const char *arg_string, int argc, int cmd_no, void *pw);
 ...
 */
#define Freeway_00                      0x047a80
#ifndef Freeway_Register
#define Freeway_Register                0x047a80
#define Freeway_Write                   0x047a81
#define Freeway_Read                    0x047a82
#define Freeway_Enumerate               0x047a83
#define Freeway_Status                  0x047a84
#define Freeway_Serial                  0x047a85
#endif

#define error_BAD_SWI ((_kernel_oserror *) -1)

_kernel_oserror *fw_swi_handler(int swi_offset, _kernel_swi_regs *r, void *pw);
 ...
 */
extern void fw_event_entry(void);

/*
 * This is the handler function you must write to handle the event for
 * which fw_event_entry is the veneer function.
 *
