...
#ifndef __cmhg_DHCPHdr_h
#define __cmhg_DHCPHdr_h
...
#define Module_Title                     "DHCP"
#define Module_Help                      "DHCP client"
#define Module_VersionString             "0.27"
#define Module_VersionNumber             27
#ifndef Module_Date
#define Module_Date                      "14 Apr 2016"
#endif
#define Module_MessagesFile              "Resources:$.Resources.DHCP.Messages"
 ...
 */
_kernel_oserror *dhcp_initialise(const char *cmd_tail, int podule_base, void *pw);
 ...
 */
_kernel_oserror *dhcp_finalise(int fatal, int podule, void *pw);
 ...
 */
void dhcp_service(int service_number, _kernel_swi_regs *r, void *pw);
...
#define CMD_DHCPInfo                    0
#define CMD_DHCPExecute                 1

_kernel_oserror *dhcp_command(const char *arg_string, int argc, int cmd_no, void *pw);
 ...
 */
#define DHCP_00                         0x052e80
#ifndef DHCP_Version
#define DHCP_Version                    0x052e80
#define DHCP_Execute                    0x052e81
#define DHCP_GetState                   0x052e82
#define DHCP_GetOption                  0x052e83
#define DHCP_SetOption                  0x052e84
#define DHCP_Inform                     0x052e85
#endif

#define error_BAD_SWI ((_kernel_oserror *) -1)

_kernel_oserror *dhcp_swi(int swi_offset, _kernel_swi_regs *r, void *pw);
 ...
 * entry veneer is called.
 */
int dhcp_event_handler(_kernel_swi_regs *r, void *pw);
