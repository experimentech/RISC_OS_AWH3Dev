...
#ifndef __cmhg_DOSFSHdr_h
#define __cmhg_DOSFSHdr_h
...
#define Module_Title                     "DOSFS"
#define Module_Help                      "DOSFS"
#define Module_VersionString             "1.13"
#define Module_VersionNumber             113
#ifndef Module_Date
#define Module_Date                      "19 Feb 2018"
#endif
#define Module_MessagesFile              "Resources:$.Resources.DOSFS.Messages"
 ...
 */
_kernel_oserror *init_fs(const char *cmd_tail, int podule_base, void *pw);
...
#define CMD_DOSMap                      0
#define CMD_CopyBoot                    1

_kernel_oserror *fs_commands(const char *arg_string, int argc, int cmd_no, void *pw);
