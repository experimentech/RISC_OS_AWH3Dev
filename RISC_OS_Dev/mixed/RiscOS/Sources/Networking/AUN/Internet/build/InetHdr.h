...
#ifndef __cmhg_InetHdr_h
#define __cmhg_InetHdr_h
...
#define Module_Title                     "Internet"
#define Module_Help                      "Internet"
#define Module_VersionString             "5.64"
#define Module_VersionNumber             564
#ifndef Module_Date
#define Module_Date                      "28 Apr 2018"
#endif
#define Module_MessagesFile              "Resources:$.Resources.Internet.Messages"
 ...
 */
_kernel_oserror *inet_init(const char *cmd_tail, int podule_base, void *pw);
 ...
 */
_kernel_oserror *inet_final(int fatal, int podule, void *pw);
...
#define CMD_InetInfo                    0
#define CMDHELP_InetInfo                1
#define CMD_InetGateway                 2
#define CMDHELP_InetGateway             3

_kernel_oserror *sock_cli_handler(const char *arg_string, int argc, int cmd_no, void *pw);
 ...
 * module Internet' to be returned.
...
_kernel_oserror *sock_swi_handler(int swi_offset, _kernel_swi_regs *r, void *pw);
