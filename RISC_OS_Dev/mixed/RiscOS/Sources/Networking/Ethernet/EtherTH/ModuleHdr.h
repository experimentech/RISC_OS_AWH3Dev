...
#define Module_Title                     "EtherTH"
#define Module_Help                      "EtherTH"
#define Module_VersionString             "0.34"
#define Module_VersionNumber             34
#ifndef Module_Date
#define Module_Date                      "25 Mar 2018"
#endif
#define Module_MessagesFile              "Resources:$.Resources.EtherTH.Messages"
...
#define CMD_ETHInfo                     0
#define CMD_ETHConfig                   1
#define CMD_ETHTune                     2
 ...
 */
#define EtherTH_00                      0x059500
#ifndef EtherTH_DCIVersion
#define EtherTH_DCIVersion              0x059500
#define EtherTH_Inquire                 0x059501
#define EtherTH_GetNetworkMTU           0x059502
#define EtherTH_SetNetworkMTU           0x059503
#define EtherTH_Transmit                0x059504
#define EtherTH_Filter                  0x059505
#define EtherTH_Stats                   0x059506
#define EtherTH_MulticastRequest        0x059507
#endif
 ...
 */
extern void ar8031_mii_interrupt(void);
extern void device_interrupt(void);

/*
 * These are the handler functions you must write to handle the
 * vectors for which ar8031_mii_interrupt, etc. are the veneer functions.
 *
