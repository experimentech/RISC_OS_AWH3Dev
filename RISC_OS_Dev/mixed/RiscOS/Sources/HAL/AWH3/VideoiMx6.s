...
;Mostly stuff in hdr.AllwinnerH3
;        GET     hdr.iMx6q
...
;H3 has no equivalent
;        GET     hdr.PRCM

;I'm sure there's some terrible secret here.
;        GET     hdr.GPIO
...
VideoDevice_Init
        ...
        LDR     a1, CCU_BaseAddr ;CCM_Base ;CCU?
        STR     a1, [a2, #VDUDevSpec_CCM_Base]
;        LDR     a1, IOMUXC_Base ;? Sort of like AW TCON?
;        STR     a1, [a2, #VDUDevSpec_IOMUXC_Base]
        LDR     a1, HDMI_BaseAddr
        STR     a1, [a2, #VDUDevSpec_HDMI_Log]
        ;We only have one register for this.
;        LDR     a1, SRC_Log      ;? system reset controller???
;        STR     a1, [a2, #VDUDevSpec_SRC_Log]
        ;Image Processing Unit.
;        LDR     a1, IPU1_Log     ;?    again may not have it
;        STR     a1, [a2, #VDUDevSpec_IPU1_Log]
;        LDR     a1, IPU2_Log      ;?   nope
;        STR     a1, [a2, #VDUDevSpec_IPU2_Log]
;        LDR     a1, CCMAn_Log    ;?
;        STR     a1, [a2, #VDUDevSpec_CCMAn_Log] ;CCM_ANALOG_PLL_ARM?
        MOV     a1, #0
        MOV     a2, v1
        CallOS  OS_AddDevice
        Pull    "v1,pc"
